...
async def get_summary(messages: list):
    ...
    prompt = (f"Please summarize the following conversation.The following conversations might also include images and other media"
...
async def on_member_join(member):
    await member.send(
        content="Welcome to the Indian PC Hardware Discord server!\nPlease go through the rules mentioned in <#1039931572465442816> and browse channles at <#1236943903693737994>.\n")
...
async def thermalpaste(ctx):
    ...
    await ctx.respond(message_content.content, ephemeral=True)
...
async def ryzenmobile(ctx):
    await ctx.respond(embed=create_embed("Naming scheme for Ryzen Mobile CPUs/APUs", commands_list['ryzenmobile']['content'], commands_list['ryzenmobile']['image_url']), ephemeral=True)
...
## /helpnearme
@bot.command(description="Get a list of members/volunteers who might be near you to get help from.")
async def helpnearme(ctx):
    await ctx.send_response("Soon :tm:",allowed_mentions=None, ephemeral=True)


# /mark3d
@bot.command(description="Get 3D-Mark Download Links")
async def mark3d(ctx):
    await ctx.send_response(embed=create_embed("3D-Mark Download Links", "steam://install/231350\nhttps://store.steampowered.com/app/223850/3DMark/"))

# /aioorientation
@bot.command(description=commands_list['aioorientation']['description'])
async def aioorientation(ctx):
    await ctx.send_response(embed=create_embed(commands_list['aioorientation']['title'], commands_list['aioorientation']['content'], commands_list['aioorientation']['image_url']))

# /airflow
@bot.command(description=commands_list['airflow']['description'])
async def airflow(ctx):
    await ctx.send_response(embed=create_embed(commands_list['airflow']['title'], "", commands_list['airflow']['image_url']))

# /biosupdate
@bot.command(description=commands_list['biosupdate']['description'])
async def biosupdate(ctx):
    await ctx.send_response(embed=create_embed(commands_list['biosupdate']['title'], commands_list['biosupdate']['content']))

# /bottleneck
@bot.command(description=commands_list['bottleneck']['description'])
async def bottleneck(ctx):
    await ctx.send_response(embed=create_embed(commands_list['bottleneck']['title'], commands_list['bottleneck']['content']))
...
async def breadboarding(ctx):
    await ctx.send_response(embed=create_embed(commands_list['breadboarding']['title'],commands_list['breadboarding']['content']))

# /btheadset
@bot.command(description=commands_list['btheadset']['description'])
async def btheadset(ctx):
    await ctx.send_response(embed=create_embed(commands_list['btheadset']['title'],commands_list['btheadset']['content']))


# /buildask
@bot.command(description=commands_list['buildask']['description'])
async def buildask(ctx):
    await ctx.send_response(embed=create_embed(commands_list['buildask']['title'],commands_list['buildask']['content']))


# /casesata
@bot.command(description=commands_list['casesata']['description'])
async def casesata(ctx):
    await ctx.send_response(embed=create_embed(commands_list['casesata']['title'],commands_list['casesata']['content'], commands_list['ryzenmobile']['image_url']))
...
async def commonsense(ctx):
    await ctx.send_response(embed=create_embed(commands_list['commonsense']['title'],commands_list['commonsense']['content']))


# /cool
@bot.command(description="Cool.")
async def cool(ctx):
    await ctx.send_response(embed=create_embed("Cool.","Cool.","https://commands.discord.eegras.com//command_images/cool.jpg"))


# /cpuboost
@bot.command(description=commands_list['cpuboost']['description'])
async def cpuboost(ctx):
    await ctx.send_response(embed=create_embed(commands_list['cpuboost']['title'], commands_list['cpuboost']['content']))
...
async def ddrjedec(ctx):
    await ctx.send_response(embed=create_embed(commands_list['ddrjedec']['title'], commands_list['ddrjedec']['content']))
...
async def driveclone(ctx):
    await ctx.send_response(embed=create_embed(commands_list['driveclone']['title'], commands_list['driveclone']['content']))


# /driverupdater
@bot.command(description=commands_list['driverupdater']['description'])
async def driverupdater(ctx):
    await ctx.send_response(embed=create_embed(commands_list['driverupdater']['title'], commands_list['driverupdater']['content']))
...
async def drivespace(ctx):
    await ctx.send_response(embed=create_embed(commands_list['drivespace']['title'], commands_list['drivespace']['content']))


# /fanconnector
@bot.command(description=commands_list['fanconnector']['description'])
async def fanconnector(ctx):
    await ctx.send_response(embed=create_embed(commands_list['fanconnector']['title'], commands_list['fanconnector']['content'], commands_list['fanconnector']['image_url']))


# /fandaisychain
@bot.command(description=commands_list['fandaisychain']['description'])
async def fandaisychain(ctx):
    await ctx.send_response(embed=create_embed(commands_list['fandaisychain']['title'], commands_list['fandaisychain']['content'], commands_list['fandaisychain']['image_url']))
...
async def fanorientation(ctx):
    await ctx.send_response(embed=create_embed(commands_list['fanorientation']['title'], commands_list['fanorientation']['content'], commands_list['fanorientation']['image_url']))


# /fantable
@bot.command(description=commands_list['fantable']['description'])
async def fantable(ctx):
    await ctx.send_response(embed=create_embed(commands_list['fantable']['title'], commands_list['fantable']['content'], commands_list['fantable']['image_url']))


# /firstdrivers
@bot.command(description=commands_list['firstdrivers']['description'])
async def firstdrivers(ctx):
    await ctx.send_response(embed=create_embed(commands_list['firstdrivers']['title'], commands_list['firstdrivers']['content']))


# /fpanel
@bot.command(description=commands_list['fpanel']['description'])
async def fpanel(ctx):
    await ctx.send_response(embed=create_embed(commands_list['fpanel']['title'], commands_list['fpanel']['content'], commands_list['fpanel']['image_url']))


# /freedomofspeech
@bot.command(description=commands_list['freedomofspeech']['description'])
async def freedomofspeech(ctx):
    await ctx.send_response(embed=create_embed(commands_list['freedomofspeech']['title'], commands_list['freedomofspeech']['content'], commands_list['freedomofspeech']['image_url']))
...
async def headsetmic(ctx):
    await ctx.send_response(embed=create_embed(commands_list['headsetmic']['title'], commands_list['headsetmic']['content'], commands_list['headsetmic']['image_url']))


# /highmonitor
@bot.command(description=commands_list['highmonitor']['description'])
async def highmonitor(ctx):
    await ctx.send_response(embed=create_embed(commands_list['highmonitor']['title'], commands_list['highmonitor']['content']))
...
async def idletemp(ctx):
    await ctx.send_response(embed=create_embed(commands_list['idletemp']['title'], commands_list['idletemp']['content']))
...
async def keyboardsize(ctx):
    await ctx.send_response(embed=create_embed(commands_list['keyboardsize']['title'], commands_list['keyboardsize']['content'], commands_list['keyboardsize']['image_url']))
...
async def m2install(ctx):
    await ctx.send_response(embed=create_embed(commands_list['m2install']['title'], commands_list['m2install']['content'], commands_list['m2install']['image_url']))


# /m2sizes
@bot.command(description=commands_list['m2sizes']['description'])
async def m2sizes(ctx):
    await ctx.send_response(embed=create_embed(commands_list['m2sizes']['title'], commands_list['m2sizes']['content'], commands_list['m2sizes']['image_url']))
...
async def mbguide(ctx):
    await ctx.send_response(embed=create_embed(commands_list['mbguide']['title'], commands_list['mbguide']['content'], commands_list['mbguide']['image_url']))
...
async def modular(ctx):
    await ctx.send_response(embed=create_embed(commands_list['modular']['title'], commands_list['modular']['content'], commands_list['modular']['image_url']))


# /motherboardsize
@bot.command(description=commands_list['motherboardsize']['description'])
async def motherboardsize(ctx):
    await ctx.send_response(embed=create_embed(commands_list['motherboardsize']['title'], commands_list['motherboardsize']['content'], commands_list['motherboardsize']['image_url']))


# /netreset
@bot.command(description=commands_list['netreset']['description'])
async def netreset(ctx):
    await ctx.send_response(embed=create_embed(commands_list['netreset']['title'], commands_list['netreset']['content']))
...
async def networkhelp(ctx):
    await ctx.send_response(embed=create_embed(commands_list['networkhelp']['title'], commands_list['networkhelp']['content']))


# /networking
@bot.command(description=commands_list['networking']['description'])
async def networking(ctx):
    await ctx.send_response(embed=create_embed(commands_list['networking']['title'], commands_list['networking']['content'], commands_list['networking']['image_url']))


# /nodisplay
@bot.command(description=commands_list['nodisplay']['description'])
async def nodisplay(ctx):
    await ctx.send_response(embed=create_embed(commands_list['nodisplay']['title'], commands_list['nodisplay']['content'], commands_list['nodisplay']['image_url']))


# /nvmesata
@bot.command(description=commands_list['nvmesata']['description'])
async def nvmesata(ctx):
    await ctx.send_response(embed=create_embed(commands_list['nvmesata']['title'], commands_list['nvmesata']['content']))
...
async def pcbuildtroubleshoot(ctx):
    await ctx.send_response(embed=create_embed(commands_list['pcbuildtroubleshoot']['title'], commands_list['pcbuildtroubleshoot']['content'], commands_list['pcbuildtroubleshoot']['image_url']))


# /pcielock
@bot.command(description=commands_list['pcielock']['description'])
async def pcielock(ctx):
    await ctx.send_response(embed=create_embed(commands_list['pcielock']['title'], commands_list['pcielock']['content'], commands_list['pcielock']['image_url']))


# /pciepower
@bot.command(description=commands_list['pciepower']['description'])
async def pciepower(ctx):
    await ctx.send_response(embed=create_embed(commands_list['pciepower']['title'], commands_list['pciepower']['content'], commands_list['pciepower']['image_url']))


# /pcieslots
@bot.command(description=commands_list['pcieslots']['description'])
async def pcieslots(ctx):
    await ctx.send_response(embed=create_embed(commands_list['pcieslots']['title'], commands_list['pcieslots']['content'], commands_list['pcieslots']['image_url']))


# /psucabletypes
@bot.command(description=commands_list['psucabletypes']['description'])
async def psucabletypes(ctx):
    await ctx.send_response(embed=create_embed(commands_list['psucabletypes']['title'], commands_list['psucabletypes']['content'], commands_list['psucabletypes']['image_url']))


# /pushpull
@bot.command(description=commands_list['pushpull']['description'])
async def pushpull(ctx):
    await ctx.send_response(embed=create_embed(commands_list['pushpull']['title'], commands_list['pushpull']['content'], commands_list['pushpull']['image_url']))
...
async def randomrestart(ctx):
    await ctx.send_response(embed=create_embed(commands_list['randomrestart']['title'], commands_list['randomrestart']['content']))


# /rgbconnector
@bot.command(description=commands_list['rgbconnector']['description'])
async def rgbconnector(ctx):
    await ctx.send_response(embed=create_embed(commands_list['rgbconnector']['title'], commands_list['rgbconnector']['content'], commands_list['rgbconnector']['image_url']))


# /rgbconnectortype
@bot.command(description=commands_list['rgbconnectortype']['description'])
async def rgbconnectortype(ctx):
    await ctx.send_response(embed=create_embed(commands_list['rgbconnectortype']['title'], commands_list['rgbconnectortype']['content'], commands_list['rgbconnectortype']['image_url']))


# /rgbcontrol
@bot.command(description=commands_list['rgbcontrol']['description'])
async def rgbcontrol(ctx):
    await ctx.send_response(embed=create_embed(commands_list['rgbcontrol']['title'], commands_list['rgbcontrol']['content']))


# /rtfm
@bot.command(description=commands_list['rtfm']['description'])
async def rtfm(ctx):
    await ctx.send_response(embed=create_embed(commands_list['rtfm']['title'], commands_list['rtfm']['content'], commands_list['rtfm']['image_url']))
...
async def sataconnection(ctx):
    await ctx.send_response(embed=create_embed(commands_list['sataconnection']['title'], commands_list['sataconnection']['content'], commands_list['sataconnection']['image_url']))


# /smart
@bot.command(description=commands_list['smart']['description'])
async def smart(ctx):
    await ctx.send_response(embed=create_embed(commands_list['smart']['title'], commands_list['smart']['content'], commands_list['smart']['image_url']))


# /smfail
@bot.command(description=commands_list['smfail']['description'])
async def smfail(ctx):
    await ctx.send_response(embed=create_embed(commands_list['smfail']['title'], commands_list['smfail']['content'], commands_list['smfail']['image_url']))


# /smnormal
@bot.command(description=commands_list['smnormal']['description'])
async def smnormal(ctx):
    await ctx.send_response(embed=create_embed(commands_list['smnormal']['title'], commands_list['smnormal']['content'], commands_list['smnormal']['image_url']))
...
async def ssdtypes(ctx):
    await ctx.send_response(embed=create_embed(commands_list['ssdtypes']['title'], commands_list['ssdtypes']['content'], commands_list['ssdtypes']['image_url']))
...
async def stfu(ctx):
    await ctx.send_response(embed=create_embed(commands_list['stfu']['title'], commands_list['stfu']['content'], commands_list['stfu']['image_url']))


# /supportchannels
@bot.command(description=commands_list['supportchannels']['description'])
async def supportchannels(ctx):
    await ctx.send_response(embed=create_embed(commands_list['supportchannels']['title'], commands_list['supportchannels']['content'], commands_list['supportchannels']['image_url']))


# /temps
@bot.command(description=commands_list['temps']['description'])
async def temps(ctx):
    await ctx.send_response(embed=create_embed(commands_list['temps']['title'], commands_list['temps']['content'], commands_list['temps']['image_url']))


# /usbc
@bot.command(description=commands_list['usbc']['description'])
async def usbc(ctx):
    await ctx.send_response(embed=create_embed(commands_list['usbc']['title'], commands_list['usbc']['content'], commands_list['usbc']['image_url']))


# /usbtypes
@bot.command(description=commands_list['usbtypes']['description'])
async def usbtypes(ctx):
    await ctx.send_response(embed=create_embed(commands_list['usbtypes']['title'], commands_list['usbtypes']['content'], commands_list['usbtypes']['image_url']))


# /userbenchmark
@bot.command(description=commands_list['userbenchmark']['description'])
async def userbenchmark(ctx):
    await ctx.send_response(embed=create_embed(commands_list['userbenchmark']['title'], commands_list['userbenchmark']['content'], commands_list['userbenchmark']['image_url']))


# /w11
@bot.command(description=commands_list['w11']['description'])
async def w11(ctx):
    await ctx.send_response(embed=create_embed(commands_list['w11']['title'], commands_list['w11']['content'], commands_list['w11']['image_url']))


# /w11installbypass
@bot.command(description=commands_list['w11installbypass']['description'])
async def w11installbypass(ctx):
    await ctx.send_response(embed=create_embed(commands_list['w11installbypass']['title'], commands_list['w11installbypass']['content'], commands_list['w11installbypass']['image_url']))


# /whackamole
@bot.command(description=commands_list['whackamole']['description'])
async def whackamole(ctx):
    await ctx.send_response(embed=create_embed(commands_list['whackamole']['title'], commands_list['whackamole']['content'], commands_list['whackamole']['image_url']))


# /whatsm2
@bot.command(description=commands_list['whatsm2']['description'])
async def whatsm2(ctx):
    await ctx.send_response(embed=create_embed(commands_list['whatsm2']['title'], commands_list['whatsm2']['content'], commands_list['whatsm2']['image_url']))


# /wic
@bot.command(description=commands_list['wic']['description'])
async def wic(ctx):
    await ctx.send_response(embed=create_embed(commands_list['wic']['title'], commands_list['wic']['content'], commands_list['wic']['image_url']))

# /windowsreinstall
@bot.command(description=commands_list['windowsreinstall']['description'])
async def windowsreinstall(ctx):
    await ctx.send_response(embed=create_embed(commands_list['windowsreinstall']['title'], commands_list['windowsreinstall']['content'], commands_list['windowsreinstall']['image_url']))


# /xmp
@bot.command(description=commands_list['xmp']['description'])
async def xmp(ctx):
    await ctx.send_response(embed=create_embed(commands_list['xmp']['title'], commands_list['xmp']['content'], commands_list['xmp']['image_url']))


# /xmpfix
@bot.command(description=commands_list['xmpfix']['description'])
async def xmpfix(ctx):
    await ctx.send_response(embed=create_embed(commands_list['xmpfix']['title'], commands_list['xmpfix']['content'], commands_list['xmpfix']['image_url']))


# /xyproblem
@bot.command(description=commands_list['xyproblem']['description'])
async def xyproblem(ctx):
    await ctx.send_response(embed=create_embed(commands_list['xyproblem']['title'], commands_list['xyproblem']['content'], commands_list['xyproblem']['image_url']))
